                    ...
                    <div class="p20">
                        <table class="table table-Light table-custom-report">
                            <tbody>
                                ...
                                <tr>
                                    <td>Call Type</td>
                                    <td>{{ $transactionDetails->call_type == null ? 'Paid' : 'Free' }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Counsellor User Mobile Number</td>
                                    <td>{{ $transactionDetails->transaction_to_user_mobile_number }}</td>
                                </tr>
                                <!-- counsellor details end -->
                                <tr>
                                    <td>Booked By User ID</td>
                                    <td>{{ $transactionDetails->transaction_by_user_id }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Booked By User Mobile Number</td>
