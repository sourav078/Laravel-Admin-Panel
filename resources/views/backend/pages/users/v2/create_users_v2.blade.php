                        ...
                        <form action="{{ route('users.store') }}" method="POST" class="p20" autocomplete="off">
                            ...
                            <div class="form">
                                <div class="form-floating mb-3">
                                    <input type="text" name="name" id="txtFullName" class="form-control" placeholder="Enter Title" value="{{old('name')}}"/>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" name="email" id="txtUserEmail" class="form-control" placeholder="type email address" value="{{old('email')}}"/>
                                    <label for="txtUserEmail">Type Email</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="mobile_number" id="txtMobileNumber" class="form-control" placeholder="type mobile number" value="{{old('mobile_number')}}"/>
