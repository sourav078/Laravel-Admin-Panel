                                    ...
                                    <div class="tab-pane fade show active p10" id="basic-information-tab">
                                        <div class="form-row">
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter User Full Name" value="{{ $user->name }}" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input type="text" name="mobile_number" id="txtMobileNumber" class="form-control" placeholder="type mobile number" value="{{ $mobile_number }}" />
                                        </div>
