        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Service Form</h4>
                    <!-- breadcumbs -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title"><b>Edit Service : {{ $service->title }}</b></h4>
                    <div class="p20">
                        <div>
                                        ...
                                        <div class="tab-pane fade show active p10" id="basic-information-tab">
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="{{ $service->title }}" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                <label for="description">Description</label>
                                                <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description">{{ $service->description }}</textarea>
                                            </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-sm-12">
                                                    <label for="image">Current Image</label><br>
                                                    <img src="{{ asset('storage/'.$service->image) }}" alt="Current Image" style="max-width: 200px; max-height: 200px;">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-sm-12">
