        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title-box">
                    <h4 class="page-title">Create Portfolio Form</h4>
                    <!-- breadcumbs -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title"><b>Create Portfolio</b></h4>
                    <div class="p20">
                        <div>
                            ...
                            <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="link" id="txtLink" class="form-control" placeholder="Enter Link" value="{{ old('link') }}" />
                                        <label for="txtLink">Enter Link</label>
                                    </div>
